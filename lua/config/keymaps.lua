...
-- ToDo: 0-9 scheinen komplett frei zu sein
vim.keymap.set({ "n" }, "<leader>11", "<cmd>Telescope keymaps<CR>")

-- Terminals
vim.keymap.set({ "v" }, "<leader>t", "<cmd>term pwsh<CR>", { noremap = true, silent = true })
...
-- LazyVim Changelog
vim.keymap.set("n",, "<leader>L", Util.changelog, {desc = "LazyVim Changelog"})
